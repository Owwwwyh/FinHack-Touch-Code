...
class RecentTransactions extends StatelessWidget {
  ...
  static const _txns = [
    ...
    _Txn(Icons.directions_car, 'PLUS Highway Toll', 'Today, 8:02 AM', '-RM 12.30',
        Color(0xFFBFDBFE), Color(0xFF2563EB), false),
...
class _Txn {
  const _Txn(this.icon, this.label, this.time, this.amount, this.bg, this.fg, this.credit);
  final IconData icon;
  final String label;
  final String time;
  final String amount;
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(txn.label, style: const TextStyle(fontSize: 14, color: Color(0xFF0F172A))),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: txn.credit ? const Color(0xFF059669) : const Color(0xFF0F172A),
            ),
          ),
        ],
      ),
